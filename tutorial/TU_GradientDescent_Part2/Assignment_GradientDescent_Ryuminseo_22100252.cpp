...
void main() {
	...
	for (int k = 0; k < itrMax; k++) {
		...
		H.at[0][0] = - eta * grad_L.at[0][0];
		H.at[1][0] = - eta * grad_L.at[1][0]; 

		Z.at[0][0] = Z.at[0][0] + H.at[0][0];
		Z.at[1][0] = Z.at[1][0] + H.at[1][0];
...
Matrix myLossGradEx3(Matrix Z, Matrix X, Matrix Y) {
	...
	for (int k = 0; k < n; k++)
	{
		...
		dL.at[0][0] = dL.at[0][0] + r ;
		dL.at[1][0] = dL.at[1][0] + X.at[k][0] * r;
	}

	dL.at[0][0] = -2 * dL.at[0][0] / n ;
	dL.at[1][0] = -2 * dL.at[1][0] / n ;
